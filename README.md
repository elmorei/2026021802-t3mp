...
- A non-perspective (orthographic) isometric-style camera with a gear-menu for view angle (default **40°**), cloud spin, light brightness (100% to 2000%), cloud elevation controls (default **60**, max **400**), elevation-change %, sphere sizing, cloud XYZ proportions, center pull factor, rain-area ratio, particle-size ratio, plus rain/vapor speed and density controls.
...
- Cloud lifecycle behavior: over water it gains larger faster chunky vapor and grows (denser footprint), and at high elevations it darkens then enters a 5-second rain sequence with larger faster chunky raindrops that extend down through the ground plane before shrinking back toward white. Rain over grass grows wildflowers that persist for 1 minute.
